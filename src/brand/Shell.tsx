...
export const MODULOS = [
  { id: 'catalogo-de-obligaciones', rotulo: 'Catálogo de obligaciones' },
  { id: 'calendario', rotulo: 'Calendario' },
  { id: 'proximos-vencimientos', rotulo: 'Próximos vencimientos' },
  { id: 'exportacion-ics', rotulo: 'Exportación .ics' },
  { id: 'responsables', rotulo: 'Responsables' },
] as const;
    ...
    <div className="flex min-h-dvh flex-col">
      ...
      <header className="no-imprimir sticky top-0 z-30 border-b border-borde bg-superficie/92 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-x-4 gap-y-2 px-4 py-3 sm:px-6">
          <a
            href="https://github.com/AndreZzRg/niand-calendario-vencimientos"
            className="shrink-0"
            aria-label="Repositorio de Calendario de Vencimientos"
          >
            <Logo alto={28} />
          </a>
          ...
          <div className="min-w-0 flex-1">
            <p className="truncate font-display text-sm font-semibold">
              <span aria-hidden>📅 </span>Calendario de Vencimientos
            </p>
