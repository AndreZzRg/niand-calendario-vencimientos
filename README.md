...
**Obligaciones periódicas laborales, de datos y de SST con exportación iCalendar**

Laboratorio 10 de la suite de cumplimiento operable de **NiAnd Labs S.A.S.**

[![CI](https://github.com/AndreZzRg/niand-calendario-vencimientos/actions/workflows/ci.yml/badge.svg)](https://github.com/AndreZzRg/niand-calendario-vencimientos/actions/workflows/ci.yml)
[![Pages](https://github.com/AndreZzRg/niand-calendario-vencimientos/actions/workflows/pages.yml/badge.svg)](https://github.com/AndreZzRg/niand-calendario-vencimientos/actions/workflows/pages.yml)
[![CodeQL](https://github.com/AndreZzRg/niand-calendario-vencimientos/actions/workflows/codeql.yml/badge.svg)](https://github.com/AndreZzRg/niand-calendario-vencimientos/actions/workflows/codeql.yml)
...
### [▶ Abrir la aplicación](https://andrezzrg.github.io/niand-calendario-vencimientos/)
...
Calendario de obligaciones periódicas de cumplimiento con reglas de recurrencia, cálculo en días hábiles sobre el calendario de festivos de Colombia, semáforo de proximidad y exportación a iCalendar (RFC 5545) para Google Calendar y Outlook.
...
```bash
git clone https://github.com/AndreZzRg/niand-calendario-vencimientos.git
cd niand-calendario-vencimientos
npm install
npm run dev
```
...
```bash
# Con GitHub CLI
gh repo create AndreZzRg/niand-calendario-vencimientos --public --source=. --remote=origin --push

# O de forma manual, si ya creó el repositorio vacío en github.com
git remote add origin https://github.com/AndreZzRg/niand-calendario-vencimientos.git
git branch -M main
...
```
https://andrezzrg.github.io/niand-calendario-vencimientos/
```
...
| **Ley 1581 de 2012 y Circular SIC 005 de 2017** | Actualización anual del RNBD. |
| **Resolución 0312 de 2019** | Autoevaluación anual de estándares mínimos del SG-SST. |
| **Ley 1010 de 2006** | Sesiones trimestrales del Comité de Convivencia Laboral. |
| **Decreto 1072 de 2015** | Plan anual de trabajo y capacitación en SST. |
