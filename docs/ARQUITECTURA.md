# Arquitectura — Calendario de Vencimientos
...
Una carpeta por módulo: `catalogo-de-obligaciones`, `calendario`, `proximos-vencimientos`, `exportacion-ics`, `responsables`.
...
`localStorage` bajo claves con prefijo `niand-calendario-vencimientos:`.
