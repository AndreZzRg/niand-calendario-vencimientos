# Registro de decisiones de arquitectura — Calendario de Vencimientos
...
**Contexto.** GitHub Pages sirve el proyecto bajo `/niand-calendario-vencimientos/`. Fijar esa ruta en la
